...
export var draw_bullet_penetration : bool = false
...
onready var leaderboard : Node = get_node(leaderboard_path)
...
func set_leaderboard_visibility(value : bool):
	leaderboard.visible = value
